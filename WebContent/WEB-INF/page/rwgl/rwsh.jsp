...
<body>
	...
	<div id="increasedis" class="clearfix" style="overflow-x: hidden;">
		...
		<div class="mws-panel grid_8 "
			...
			<div id="khxx" class="mws-panel-body" style="height:250px; padding:10px;">
				<p class="khxx_p">
				...
				<p class="khxx_p" style="text-align:center">
					<c:if test="${type=='qyyh'}">
					<input style="width:80px;" type="button" alt="" id="subbtn" value="确认审核" />
				   </c:if>
				   <c:if test="${type=='jtyh'}">
					<input style="width:80px;" onclick="jt()" type="button" alt="" id="subbtn" value="确认审核" />
				</c:if>	
