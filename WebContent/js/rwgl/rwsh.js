$(document).ready(function(){
	...
	for(var i = 0; i < xinList.length; i++) {
			...
			if(type=="qyyh"){
				html += "<td><input class='checkinp' alt="+i+" type='button' value='查看' /><input class='stateinp' alt="+i+" type='button' value='未审核' /></td>"
			}else{
				html += "<td><input class='checkinp' alt="+i+" type='button' value='查看' /></td>"
			}
